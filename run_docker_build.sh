...
aurman -Syu --noedit --noconfirm mingw-w64-fftw mingw-w64-agrum mingw-w64-libmixmod  # for otfftw, otagrum, otmixmod
...
# for each module
for pkgnamever in otagrum-0.12 otfftw-0.17 otmixmod-0.19 otmorris-0.18 otrobopt-0.16 otsvm-0.16
do
